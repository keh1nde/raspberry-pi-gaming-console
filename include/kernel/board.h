...
/**
	...
	*  manages frames up to but not including this address. */
	...
	/*
	 * SDIO MMIO Addresses and Offsets
	 *
	 * Contains MMIO addresses for the BCM2712's SDHCI controller.
	 * Retrieved from
	 *  - The SD Association's SD Host Controller Simplified
	 *  Specification Version 4.20 and
	 *  - The retail Pi 5 board files from Linux, specifically
	 *   - arch/arm64/boot/dts/broadcom/bcm2712.dtsi
	 *   - drivers/mmc/host/sdhci-brcmstb.c
	 *   - drivers/pinctrl/bcm/pinctrl-brcmstb-bcm2712.c, drivers/pinctrl/bcm/pinctrl-brcmstb.c,
	 *   and drivers/pinctrl/bcm/pinctrl-brcmstb.h for pin related information
	 *
	 * Note that this set does not contain the UHS-II register addresses as
